...
import CurrentInfo from './Blocks/CurrentInfo';
//-----------------------------------Items-------------------------------------------------------------
...
import CurrentButtons from './Blocks/CurrentBtn';
//-----------------------------------Icons-------------------------------------------------------------
import Banner from './Icons/Banner'


export {CurrentInfo, CurrentButtons, IconButton, Playlist, TextComponent, TextButton, Banner, HeaderBlock,ValidationSelectorBtn, Playlists, MusicList, CurrentMusic, Search, Title, LoginForm, SignUpForm, ValidationHeader}